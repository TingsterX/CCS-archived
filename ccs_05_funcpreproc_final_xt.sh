...
then
	## 1. Temporal filtering
        ...
        then
                for hemi in lh rh
                do
			rm -f ${gsFC_dir}/tmp_${rest}_pp_sm0.nii.gz
			3dresample -orient RSP -prefix ${gsFC_dir}/tmp_${rest}_pp_sm0.nii.gz -inset ${gsFC_dir}/${rest}_pp_sm0.nii.gz 
                        mri_vol2surf --mov ${gsFC_dir}/tmp_${rest}_pp_sm0.nii.gz --reg ${func_reg_dir}/bbregister.dof6.dat --trgsubject ${fsaverage} --interp trilin --projfrac 0.5 --hemi ${hemi} --o ${gsFC_dir}/${rest}.pp.sm0.${fsaverage}.${hemi}.nii.gz --noreshape --cortex --surfreg sphere.reg
			rm ${gsFC_dir}/tmp_${rest}_pp_sm0.nii.gz

			rm -f ${FC_dir}/tmp_${rest}_pp_sm0.nii.gz
                        3dresample -orient RSP -prefix ${FC_dir}/tmp_${rest}_pp_sm0.nii.gz -inset ${FC_dir}/${rest}_pp_sm0.nii.gz
			...
			rm ${FC_dir}/tmp_${rest}_pp_sm0.nii.gz
