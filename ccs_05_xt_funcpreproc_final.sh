...
#then
	...
	rm -rv ${gsFC_dir}/${rest}_filt_mean.nii.gz ${gsFC_dir}/${rest}_dt.nii.gz ${gsFC_dir}/${rest}_pp_sm0.nii.gz
        ...
        rm -rv ${FC_dir}/${rest}_filt_mean.nii.gz ${FC_dir}/${rest}_dt.nii.gz ${FC_dir}/${rest}_pp_sm0.nii.gz
